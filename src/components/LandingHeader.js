...
export default function LandingHeader( { activeTab }) {
    ...
    return (
        <header className="h-16">
            <ul role="tablist"
                className="h-full flex flex-nowrap justify-center text-sm font-medium text-center text-white bg-gray-700 bg-opacity-50 dark:border-gray-700 dark:text-gray-400">
                ...
                <li role="tab" aria-selected="" className="me-2 flex align-middle">
                    <Link href="/browse" id="Browse"
                       className={activeTab === "Index" ? "p-4 flex items-center rounded-t-lg bg-gray-200 text-black text-lg" :
                           "p-4 flex items-center rounded-t-lg hover:bg-gray-200 hover:text-black text-base"}
                    >
                        { tr("Browse") }
                    </Link>
